...
namespace RgApi.Migrations
{
    ...
    [Migration("20190929180047_AddModelsAndDBSets")]
    partial class AddModelsAndDBSets
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RgApi.Models.BillingDetail", b =>
                {
            ...
            modelBuilder.Entity("RgApi.Models.CartItem", b =>
                {
            ...
            modelBuilder.Entity("RgApi.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("RgApi.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("RgApi.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("RgApi.Models.Price", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RgApi.Models.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RgApi.Models.CartItem", b =>
                {
                    b.HasOne("RgApi.Models.Price", "Price")
                        .WithMany()
                        .HasForeignKey("PriceId");

                    b.HasOne("RgApi.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("RgApi.Models.Order", b =>
                {
                    b.HasOne("RgApi.Models.BillingDetail", "BillingDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("RgApi.Models.OrderDetail", b =>
                {
                    b.HasOne("RgApi.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId");

                    b.HasOne("RgApi.Models.Price", "ProductPrice")
                        .WithMany()
